...
def MakingWavFile(DataDir, DstDir):
	...
	with open(os.path.join(DstDir,"wav.scp"),"w+") as writer:
		for utt in utt_id_list:
			wav_file = f"{utt}.wav"
			wav_path = os.path.join(DataDir,wav_file)
...
if __name__ == '__main__':
	...
	DATADIR = "/path/to/folder/with/wavfiles/" # Replace this with the folder that you have your wav files
	...
	DSTDIR = "/path_to_Kaldi_dir/train/data/" 
