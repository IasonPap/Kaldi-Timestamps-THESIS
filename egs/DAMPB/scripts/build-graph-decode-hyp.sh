...
scripts/correct_segment.py $working_dir/ref_and_hyp.final \
							$island_length > $working_dir/ref_and_hyp_match 2>> $log_dir/err.log || exit 1
scripts/correct_segment.py $working_dir/hyp_and_ref.final \
							$island_length > $working_dir/hyp_and_ref_match 2>> $log_dir/err.log || exit 1
