...
scripts/islands_to_status.py $working_dir/ref_and_hyp_match \
							$working_dir/hyp_and_ref_match \
        					$working_dir/text_ints \
							$working_dir/word_alignment.ctm \
							$working_dir/segments \
							$text_begin_index \
							$text_end_index \
							$audio_begin_time \
							$audio_end_time > $working_dir/ALIGNMENT_STATUS 2>> $log_dir/err.log
...
scripts/segment_to_actual_word_time.py $main_working_dir/WORD_TIMINGS.tmp \
										$working_dir/word_alignment.ctm \
										$working_dir/segments \
										$working_dir/ref_and_hyp_match \
										$working_dir/hyp_and_ref_match \
										$text_begin_index > $main_working_dir/WORD_TIMINGS
